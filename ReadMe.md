...
//Route match allows you to add nested routes to the app. You can change a parameter once without changing everywhere else its used.


2. How would you explain form validation to someone who has never programmed before?

//It just helps us make sure that the form we are creating, complies with whatever instructions we give it when a user tries to fill it out. 

3. In 1-2 sentences, define end to end testing.

tools like cypress helps guarantee that our entire project works from start to finish. it lets us know that the user can accomplish the action that the component is inteded to do.
